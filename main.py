...
def save_checkpoint(model, epoch):  # save model function
    model_out_path = './weights/CSNET0.pth'
...
if __name__ == "__main__":
    ...
    train_set = Dataset_Pro('E:/HJM_Datasets/new_pan/training_wv3/train_wv3.h5')
    # train_set = Dataset_Pro('./data/wv3/train_wv3.h5')  # create data for training
    training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches

    validate_set = Dataset_Pro('E:/HJM_Datasets/new_pan/training_wv3/valid_wv3.h5')  # create data for validation
